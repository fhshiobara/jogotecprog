...
void Jogo::executar() {
    ...
    Gerenciadores::SingleFrameAnimation* background = new Gerenciadores::SingleFrameAnimation("../assets/background.png",CoordF(0.0f,0.0f),CoordF(800.0f,600.0f),0.997);
